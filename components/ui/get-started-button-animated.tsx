...
const COLORS: Colors = {
  color1: '#FFFFFF',
  color2: '#00f0ff', // Cyber neon
  color3: '#00ff66', // Cyber green
  color4: '#FCFCFE',
  color5: '#F9F9FD',
  color6: '#B2B8E7',
  color7: '#00f0ff',
...
interface GetStartedButtonAnimatedProps {
    onClick: () => void;
}

export const GetStartedButtonAnimated = ({ onClick }: GetStartedButtonAnimatedProps) => {
  ...
  return (
    <div className="flex justify-center">
      <button
        ...
        className="relative inline-block w-48 h-[3.5em] mx-auto group bg-black border-2 border-cyber-neon rounded-xl overflow-hidden shadow-[0_0_15px_rgba(0,240,255,0.2)] hover:shadow-[0_0_30px_rgba(0,240,255,0.4)] transition-all duration-300"
      >
        ...
        <span className="absolute inset-0 flex items-center justify-center gap-2 text-white font-bold text-lg tracking-wide whitespace-nowrap">
          Get Started
